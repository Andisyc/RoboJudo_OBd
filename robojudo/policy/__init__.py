...
policy_registry.add("UniLabPolicy", ".unilab_policy")
policy_registry.add("UniLabDistillPolicy", ".unilab_distill_policy")
policy_registry.add("FADAPlannerIDMPolicyAdapter", ".fada_policy")
